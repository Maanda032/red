...
export default function Amout() {
  ...
  const [btntxt, setbtntxt] = useState("Enable mood")
  ...
  <div className='container my-3'>  <button button type="button" className="btn btn-primary" onClick={toggleStyle}>{btntxt}</button> 
  </div>
  </div>
